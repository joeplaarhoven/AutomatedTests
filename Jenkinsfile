pipeline {
  ...
  stages {
    ...
    stage('GUI test') {
      ...
      steps {
        sh 'katalonc  -projectPath="/var/jenkins_home/workspace/AutomatedTests_master/gui_test/DemoWebshopGUITest.prj" -browserType="Edge" -testSuitePath="GUI_Test_Suite" -apiKey="909a5194-ea06-4745-8a5e-59a676c786f3" '
      }
    }
  }
}