...
//     }
    stage('GUI test') {
      steps {
          dir('/var/jenkins_home/workspace/AutomatedTests_master@2'){
              sh 'docker run -t --rm -v "$(pwd)":/tmp/project katalonstudio/katalon katalonc.sh -projectPath=/gui_test/DemoWebshopGUITest -browserType="Chrome" -retry=0 -statusDelay=15 -testSuitePath="GUI_Test_Suite" -apiKey=909a5194-ea06-4745-8a5e-59a676c786f3'
          }
      }
//
