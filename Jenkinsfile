...
//     }
    stage('GUI test') {
      agent any
      steps {
        sh 'docker run -t --rm -v "$(pwd)":/tmp/project katalonstudio/katalon katalonc.sh -projectPath="/var/jenkins_home/workspace/AutomatedTests_master@2/gui_test/DemoWebshopGUITest.prj" -browserType="Chrome" -retry=0 -statusDelay=15 -testSuitePath="GUI_Test_Suite" -apiKey=909a5194-ea06-4745-8a5e-59a676c786f3'
      }
//
